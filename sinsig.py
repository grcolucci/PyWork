...
master.geometry("740x840")

#Scale(frame, from_=0.55, to=4.75, digits = 3, resolution = 0.01, label = "Lower")
ampSlider = Scale(master, from_=0.00, to=10.2, digits=3, resolution = 0.02, label="Amplitude", length=1200, tickinterval=0.02, orient=HORIZONTAL)
ampSlider.set(3.6)
ampSlider.pack()
